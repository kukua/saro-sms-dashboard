...
$sent_email_logs = $this->db
                ...
                ->where('e.sent_by = u.id and e.email_status in (1)')        
            ...
            <tbody>
                ...
                foreach ($sent_email_logs as $sent_email):
                    ...
                    <tr>
                        ...
                        <td><?php echo $sent_email->counts;?></td>
                        ...
                        <td>
                           <?php echo $this->spectrum_func->delivery_status($sent_email->email_status);?> &nbsp;
                            <?php echo anchor('admin_emails/resend_sent_email/'.$sent_email->uuid,'<i class="fa fa-refresh fa-lg"></i> ',
                                   array('onclick'=>"return confirm('You are about to resend this message')"));?>&nbsp;
                           <?php echo anchor('admin_emails/download_sent_emails/'.$sent_email->uuid,'<i class="fa fa-download fa-lg"></i>',array('class'=>''));?>
                        </td>
