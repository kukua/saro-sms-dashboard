            ...
            <tbody>
                ...
                foreach ($contact_group_logs as $contact_group):
                    ...
                    <tr>
                        ...
                        <td><?php echo anchor('admin_phonebook/contacts/'.$contact_group->id*date('Y'),$contact_group->group_name);?></td>
                        <td>
                            <a  href="#formModal<?php echo $contact_group->id?>"  data-toggle="modal"> <i class="fa fa-edit fa-lg"></i></a>&nbsp;
                           <?php echo anchor('admin_phonebook/delete_group/'.$contact_group->id*date('Y'),'<i class="fa fa-trash-o fa-lg"></i>',array('onclick'=>"return confirm('You are about to delete this group name')"));?>
                        </td>

                        

                            <div class="modal fade" id="formModal<?php echo $contact_group->id?>">
                            <?php echo form_open('admin_phonebook/group_name_edit')?>
