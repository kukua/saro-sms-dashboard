                    ...
                    foreach ($sent_item_logs as $sent_item):
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo anchor('user_messages/resend_sent_messages/' . $sent_item->message_id, '<i class="fa fa-refresh fa-lg"></i> ', array('onclick' => "return confirm('You are about to resend this message')"));
                                ?>&nbsp;
                                <?php echo anchor('user_messages/download_messages/' . $sent_item->message_id, '<i class="fa fa-download fa-lg"></i>', array('class' => '')); ?>
                            </td>
