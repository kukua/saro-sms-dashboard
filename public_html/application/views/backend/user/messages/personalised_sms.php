...
<div class="panel panel-default">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered dataTable no-footer" id="jq_message_log" aria-describedby="jq-datatables-example_info">
                <thead>
                    <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="jq-datatables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 80%;" >
    ...
    <div class="row block-body">
        ...
        <div class="col-sm-12">
            <?php echo form_open('user_messages/send_psms_bulk', array('class' => 'panel form-horizontal', 'id' => 'sms-form')); ?>
            <div class="panel-heading">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group no-margin-hr">
                            ...
                            <input type="text" required="required"  name="sender" id="sender"  class="form-control" value="">
                        </div>
                    </div><!-- col-sm-6 -->
                    <div class="col-sm-4">
                        <div class="form-group no-margin-hr">
