                    ...
                    <tr>
                        ...
                        <td>
                           <?php echo $this->spectrum_func->delivery_status($sent_item->delivery_status);?> &nbsp;
                            <?php echo $sent_item->delivery_status==1? anchor('user_messages/resend_sent_messages/'.$sent_item->message_id,'<i class="fa fa-refresh fa-lg"></i> ',
                                   array('onclick'=>"return confirm('You are about to resend this message')")):"";?>&nbsp;
                           <?php echo $sent_item->delivery_status==0? anchor('user_messages/download_messages/'.$sent_item->message_id,'<i class="fa fa-download fa-lg"></i>',array('class'=>'')):"";?>
                        </td>
