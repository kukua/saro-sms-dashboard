...
//Constructor..
    public function Submit($host, $username, $password, $sender, $message, $mobile, $msgtype, $dlr) {
        $this->host = $host;
        ...
        if ($this->strMessageType == "2" ||
            ...
            $live_url = $this->host ."?username=" . $this->strUserName . "password=" . $this->strPassword . "&type=" . $this->strMessageType . "&dlr=" . $this->strDlr . "&destination=" . $this->strMobile . "&source=" . $this->strSender . "&message=" . $this->strMessage . "";
