...
<div class="panel panel-default">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered dataTable no-footer" id="jq_message_log" aria-describedby="jq-datatables-example_info">
                    ...
                    <tbody>
                        ...
                        <center>
                            ...
                            <?php
                            if (1) {
                                echo anchor('admin_phonebook/delete_contact/' . $rows->id * date('Y') . '/' . $id * date('Y'), '<i class="fa fa-trash-o"></i>', array('onclick' => "return confirm('You are about to delete this contact')"));
                            }
                            ?>
                        </center>
                        </td>
    ...
    foreach ($rst as $rows) {
        ...
        <?php echo form_open('admin_phonebook/update_contact/' . $id * date('Y'), array('enctype' => 'multipart/form-data')) ?>
