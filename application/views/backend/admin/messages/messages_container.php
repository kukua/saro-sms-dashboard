                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           if($sent_item->delivery_status==0):
                              echo anchor('admin_messages/send_now/'.$sent_item->message_id,'<i class="fa fa-rocket fa-lg"></i> ',
                                   array('onclick'=>"return confirm('You are about to send this message')")); 
                           endif;
                           ?>
                            <?php echo anchor('admin_messages/resend_sent_messages/'.$sent_item->message_id,'<i class="fa fa-refresh fa-lg"></i> ',
