...
<div class="panel panel-default">
    ...
    <div class="profile-content">
        ...
        <ul id="profile-tabs" class="nav nav-tabs">
            ...
            <li>
                <a href="#profile-tabs-basic-http" data-toggle="tab">Basic HTTP (JSON)</a>
            </li>
             <li>
                <a href="#profile-tabs-basic-http2" data-toggle="tab">Basic HTTP (CODES)</a>
            </li>
        </ul>
...
<p>The items in [] should be replaced by your details.Note that [To] can be comma separated for bulk messaging</p>
                                                    <code class="php">
&lt;?php<br>
include "./vendor/autoload.php";

//send sms url
$url = '<?php echo base_url()?>api/1/sms/send';
...
<code class="json">
{"code":"1024","message":"Messages Sent to Queue","count"=>[NUMBER-OF-SMS-SENT]}

{"code":"1025","message":"Failed to send SMS to process Queue! Parameters not provided"}

{"code":"1026","message":"Sorry, Insurficient funds"}

{"code":"1027","message":"Sorry, Your profile SMS is not complete. please contact admin"}
...
{"code":"1028","message":"Sorry, You need to encrypt your data"}
            ...
            <div class="tab-pane fade widget-followers fade in " id="profile-tabs-basic-http">
                <div class="follower">
                    <div class="body">
                        <div class="padding-md">
                            <div class="row">
...
<code class="php">
    ...
    //send sms url
    $url = '<?php echo base_url()?>api/0/sms/send';
...
{"code":"1027","message":"Sorry, Your profile SMS is not complete. please contact admin"}
             ...
             <div class="tab-pane fade widget-followers fade in " id="profile-tabs-basic-http2">
                <div class="follower">
                    <div class="body">
                        <div class="padding-md">
                            <div class="row">
...
<code class="php">
    ...
    //send sms url
    $url = '<?php echo base_url()?>api/2/sms/send';
...
1024 - Successfully Sent to Queue

1025 - Failed to send SMS to process Queue! Parameters not provided

1026 - Sorry, Insurficient funds

1027 - Sorry, Your profile SMS is not complete. please contact admin
