...
class Admin_phonebook extends Spectrum_Controller {
    ...
    public function delete_group($id = null) {
        ...
        $this->data['view'] = 'backend/admin/phonebook/phonebook_container';
    ...
    public function delete_contact($id = null, $id2 = null) {
        ...
        $this->data['view'] = 'backend/admin/phonebook/contacts';
        $this->data['viewstatus'] = 'phonebook';
    ...
    public function upload_contacts($id = null, $idparent = null) {
        $this->data['view'] = 'backend/admin/phonebook/upload_contacts';
        $this->data['viewstatus'] = 'phonebook';
        $this->data['id'] = $id / date('Y');
        $this->load_view($this->data);
    }
    ...
    public function create_upload_contacts($id = null, $idparent = null) {
        ...
        if (isset($_POST['upload'])) {
            $this->data['view'] = 'backend/admin/phonebook/create_upload_contacts';
            $this->data['viewstatus'] = 'phonebook';
        ...
        if (strlen($this->session->userdata('file_name')) > 0) {
            ...
            redirect('admin_phonebook/phonebook', 'refresh');
        }
        parent::load_view($this->data);
    }
    ...
    public function add_contact($id = null) {
        ...
        $this->data['view'] = 'backend/admin/phonebook/add_contact';
        $this->data['viewstatus'] = 'phonebook';
        $this->data['id'] = $id / date('Y');
        $this->load_view($this->data);
    }
